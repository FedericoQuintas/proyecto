...
public class TradingSessionFactory {
	...
	public static TradingSession create(TradingSessionDTO tradingSessionDTO) 
		...
		TradingSession tradingSession = new TradingSession(tradingSessionDTO.getTradingDate());
	...
	private static void validateMandatoryFields(
			TradingSessionDTO tradingSessionDTO) throws InvalidTradingSessionArgumentException {
		try{
